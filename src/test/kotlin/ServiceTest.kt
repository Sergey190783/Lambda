...
internal class ServiceTest {
    ...
    fun sendMessage() {
        ...
        assertEquals(1, service.getChats(1).size)
        assertEquals(1, service.getChats(2).size)
    }
    ...
    fun sendMessage1() {
        ...
        assertEquals(1, service.getChats(2).size)
        assertEquals(1, service.getChats(3).size)
    }
    ...
    fun getMessages(){
        ...
        assertEquals(2, service.getMessages(1,2,2)?.size)
    }
    @Test
